...
export default {
    ...
    methods: {
        async downloadBtn() {
            try {
                var datalabelbox = ['Label Box','Name : CONSOLE FLOOR FR LWR','Qty : 10','Prod.Date : 05/12/2022','No.Work Order : 123328493','Supplier : TKI','No Box : 435345-XXX'];
                // var imgData = await QRCode.toDataURL(this.g$list); codingan awal
                var imgData = await QRCode.toDataURL("'Label Box','Name : CONSOLE FLOOR FR LWR','Qty : 10','Prod.Date : 05/12/2022','No.Work Order : 123328493','Supplier : TKI','No Box : 435345-XXX'");
